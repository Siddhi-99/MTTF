  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: plan.featured
          ? "0 20px 50px rgba(26,18,10,0.15)"
    ...
    >
      ...
      <div style={{
        fontFamily: "'Jost', sans-serif",
        fontSize: "0.6rem",
        color: plan.featured ? "rgba(232,217,192,0.4)" : "rgba(90,65,40,0.4)",
...
function LuxuryNav() {
  ...
  return (
    <nav style={{
      ...
      top: 0,
      zIndex: 100,
      background: scrolled ? "rgba(252,248,240,0.97)" : "#FBF6EC",
      borderBottom: "1px solid rgba(139,112,72,0.15)",
      backdropFilter: "blur(8px)",
      boxShadow: scrolled ? "0 2px 24px rgba(139,112,72,0.08)" : "none",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.65rem", flexShrink: 0 }}>
          ...
          <span style={{
            fontFamily: "'Playfair Display', serif",
            fontSize: "1.05rem", fontWeight: 700, color: "#1A120A", letterSpacing: "0.02em",
          }}>MTTF</span>
        </div>

        {/* Nav */}
        <div style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
          {["Listings", "About", "Services"].map(link => (
            <a key={link} href="#" style={{
              fontFamily: "'Jost', sans-serif",
              fontSize: "0.8rem", letterSpacing: "0.12em",
              textTransform: "uppercase", color: "#5C4A32", textDecoration: "none",
              fontWeight: 400, transition: "color 0.2s",
            }}
              onMouseEnter={e => e.target.style.color = "#C9A84C"}
              onMouseLeave={e => e.target.style.color = "#5C4A32"}
            >{link}</a>
          ))}
        </div>
        ...
        <button style={{
          ...
          color: "#1A120A", background: "transparent",
          border: "1px solid rgba(201,168,76,0.6)",
          padding: "0.6rem 1.4rem", cursor: "pointer",
          borderRadius: "1px", transition: "all 0.3s ease", flexShrink: 0,
        }}
          onMouseEnter={e => { e.target.style.background = "#C9A84C"; e.target.style.color = "#fff"; e.target.style.borderColor = "#C9A84C"; }}
          onMouseLeave={e => { e.target.style.background = "transparent"; e.target.style.color = "#1A120A"; e.target.style.borderColor = "rgba(201,168,76,0.6)"; }}
        >
          Get a Free Consultation
        </button>
      </div>
      {/* Gold shimmer divider */}
      <div style={{ height: "1px", background: "linear-gradient(90deg, transparent, rgba(201,168,76,0.4) 30%, rgba(201,168,76,0.6) 50%, rgba(201,168,76,0.4) 70%, transparent)" }} />
    </nav>
  );
}
...
function LuxuryFooter() {
  return (
    <footer style={{ background: "#1A120A", color: "#E8D9C0", borderTop: "1px solid rgba(201,168,76,0.2)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "3rem 2rem" }}>
        {/* Quote */}
        <div style={{ borderLeft: "2px solid rgba(201,168,76,0.4)", paddingLeft: "1.5rem", marginBottom: "2.5rem" }}>
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "1rem", color: "rgba(232,217,192,0.6)", fontStyle: "italic", lineHeight: 1.6, margin: 0 }}>
            "Advancing STEM through community, knowledge, and opportunity."
          </p>
        </div>

        <div style={{ display: "flex", flexWrap: "wrap", gap: "2rem", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.2rem", fontWeight: 700, color: "#E8D9C0", marginBottom: "0.4rem" }}>MTTF</div>
            <div style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.7rem", color: "rgba(232,217,192,0.35)", letterSpacing: "0.15em", textTransform: "uppercase" }}>MathTech Thinking Foundation</div>
          </div>

          <div style={{ display: "flex", flexDirection: "column", gap: "0.35rem" }}>
            {[["Brokerage License", "#BR-2024-MT-001"], ["Agent License", "#AG-2024-MT-007"], ["Foundation", "MathTech Thinking Foundation"], ["Contact", "lifetimemember@mttf.in"]].map(([label, value]) => (
              <div key={label} style={{ display: "flex", gap: "0.75rem", alignItems: "baseline" }}>
                <span style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.68rem", color: "rgba(201,168,76,0.55)", letterSpacing: "0.1em", textTransform: "uppercase", minWidth: "110px" }}>{label}</span>
                <span style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.78rem", color: "rgba(232,217,192,0.5)" }}>{value}</span>
              </div>
            ))}
          </div>

          <div style={{ display: "flex", flexDirection: "column", gap: "0.65rem" }}>
            <div style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.6rem", color: "rgba(201,168,76,0.45)", letterSpacing: "0.2em", textTransform: "uppercase" }}>Follow</div>
            {["Facebook", "Instagram", "LinkedIn"].map(s => (
              <a key={s} href="#" style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.8rem", color: "rgba(232,217,192,0.45)", textDecoration: "none", transition: "color 0.2s" }}
                onMouseEnter={e => e.target.style.color = "#C9A84C"}
                onMouseLeave={e => e.target.style.color = "rgba(232,217,192,0.45)"}
              >{s}</a>
            ))}
          </div>
        </div>
      ...
      <div style={{ borderTop: "1px solid rgba(201,168,76,0.08)", padding: "1rem 2rem", display: "flex", flexWrap: "wrap", gap: "1rem", justifyContent: "space-between", alignItems: "center", maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "flex", gap: "1.5rem" }}>
          {["Privacy Policy", "Terms & Conditions", "Accessibility"].map(link => (
            <a key={link} href="#" style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.68rem", color: "rgba(232,217,192,0.3)", textDecoration: "none", letterSpacing: "0.05em", transition: "color 0.2s" }}
              onMouseEnter={e => e.target.style.color = "rgba(201,168,76,0.7)"}
              onMouseLeave={e => e.target.style.color = "rgba(232,217,192,0.3)"}
            >{link}</a>
          ))}
        </div>
        <div style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.68rem", color: "rgba(232,217,192,0.2)", letterSpacing: "0.05em" }}>
          © 2026 MTTF. All rights reserved.
        </div>
      </div>
    </footer>
  );
...
export default function Individual() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#FBF6EC", color: "#1A120A" }}>
      ...
      {/* Use project Header or luxury nav — keep your own Header component below */}
      <Header />
      ...
      <main style={{ flex: 1 }}>
        ...
        >
          ...
          {[
            ...
            { top: "46%", left: "4%", delay: "0.6s", dur: "5s" },
          ].map((dot, i) => (
            <div key={i} style={{
              position: "absolute",
              width: 4, height: 4,
        ...
        <section style={{ maxWidth: "1300px", margin: "0 auto", padding: "5rem 2rem" }}>
          ...
          <p style={{
            ...
            your professional growth and networking opportunities. Some of the key member benefits include:
          </p>
