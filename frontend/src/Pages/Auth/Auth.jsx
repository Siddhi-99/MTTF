...
export default function Auth() {
  ...
  const [page, setPage] = useState("login"); // default: signin
  ...
  const handleSignup = (e) => {
    ...
    localStorage.setItem("user", JSON.stringify({ ...form, membershipType }));
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-toggle-wrap {
          ...
          padding: 4px;
          margin-bottom: 32px;
          border: 1px solid rgba(185,148,60,0.2);
        }
        ...
        .auth-input {
          ...
          padding: 12px 16px;
          background: #fff;
          border: 1px solid rgba(185,148,60,0.25);
          border-radius: 0;
          font-family: 'DM Sans', sans-serif;
          font-size: 13.5px;
          font-weight: 300;
        ...
        .mem-type-card {
          padding: 16px;
          border: 1.5px solid rgba(185,148,60,0.25);
          background: #fff;
          cursor: pointer;
          text-align: center;
        ...
        .mem-type-card.selected {
          border-color: #b9943c;
          background: rgba(185,148,60,0.07);
        }
        ...
        .auth-select option { color: #1a1610; background: #fff; }

        .inst-reveal {
          animation: revealDown 0.3s cubic-bezier(0.16,1,0.3,1) both;
        }
          ...
          <div className="auth-modal-body">
            ...
            {page === "membership" ? (
              <>
                ...
                <h2 className="auth-title">Welcome, Member</h2>
                ...
                <div className="mem-welcome">
                  ...
                  <button className="mem-logout" onClick={() => setPage("login")}>Sign Out</button>
                </div>
              </>
            ) : (
              <>
                ...
                <div className="auth-toggle-wrap">
                  <button
                    className={`auth-toggle-btn ${page === "login" ? "active" : ""}`}
                    onClick={() => setPage("login")}
                  >
                    Sign In
                  </button>
                  <button
                    className={`auth-toggle-btn ${page === "signup" ? "active" : ""}`}
                  ...
                  <form onSubmit={handleSignup}>
                    ...
                    <div className="auth-field">
                      ...
                      <div className="mem-type-grid">
                        <div
                          className={`mem-type-card ${membershipType === "individual" ? "selected" : ""}`}
                        ...
                        <div
                          className={`mem-type-card ${membershipType === "institutional" ? "selected" : ""}`}
                    ...
                    {/* Institution Size — only shown for Institutional */}
                    ...
                    <p className="auth-footer-link">
                      ...
                      <button type="button" onClick={() => setPage("login")}>Sign In</button>
                    </p>
                  </form>
                )}
                ...
                {page === "login" && (
                  <form onSubmit={handleLogin}>
                    ...
                    <p className="auth-footer-link">
                      New member?{" "}
                      <button type="button" onClick={() => setPage("signup")}>Create Account</button>
                    </p>
                  </form>
                )}
              </>
